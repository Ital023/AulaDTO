export default function HomeBody() {
  return (
    <main className="flex flex-col justify-center items-center py-10 gap-4">
      ...
      <p>Assista a aula:</p>
      <iframe width="560" height="315" src="https://www.youtube.com/embed/Yw4TwGho320?si=UA0Pk6bAccHUdozz" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
      <a className="underline text-blue-500" href="https://www.youtube.com/watch?v=Yw4TwGho320" target="_blank">Acessar a aula</a>
    </main>
  );
}
